...
class _SettingsPageState extends State<SettingsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('MongoDB + Cloudflare')),
      body: ListView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SelectableText(
                    ...
                    'Network Access → Allow 0.0.0.0/0 (Cloudflare ke liye)\n'
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(
                      labelText: 'API URL',
                      hintText: 'http://localhost:5050  ya  https://….workers.dev',
                    ),
                  ),
          ...
          const Card(
            child: Padding(
              ...
              child: Text(
                ...
                'Cloudflare Worker website + /api dono serve karta hai. '
                'Live URL Settings mein paste karo (debug), release build same origin use karti hai.',
              ),
            ),
          ),
        ],
